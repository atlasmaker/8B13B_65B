...
# ACDS 20.1 720 win32 2021.10.18.16:58:11
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ClockBridge_pll_0.vo" -work pll_0 -cdslib ./cds_libs/pll_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ClockBridge.v"                                                               
fi
